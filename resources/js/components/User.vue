        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action method="post" enctype="multipart/form-data" class="form-horizontal">
              ...
              <div class="form-group row">
                <label class="col-md-3 form-control-label" for="text-input">Repetir password (*)</label>
                <div class="col-md-9">
                  <input
                    type="password"
                    class="form-control"
                    placeholder="Password de verificación"
                    v-model="password_verificacion"
                  >
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    validarPersona() {
      ...
      if (this.password != this.password_verificacion) {
        this.errorMostrarMsjPersona.push("Las contraseñas no coinciden");
      }
    ...
    desactivarUsuario(id) {
      ...
      swalWithBootstrapButtons
        .fire({
          title: "¿Esta seguro de este usuario?",
          type: "warning",
